  ...
  return (
    ...
    >
      ...
      <Text alignSelf={'center'} textAlign="center" marginTop={2} fontSize="md">
        {' '}
        DarkMatter will be a web browser and text-based sci-fi war simulator and MMO that many consider to be the "lite"
        version of EVE Online.
      </Text>
      <Text alignSelf={'center'} textAlign="center" marginTop={4} fontSize="md">
        DarkMatter is a text-based space simulation strategy MMO available for internet browser. Its gameplay is similar
        to Eve Online but it lacks three-dimensional visuals and focuses primarily as a text-based game. Players begin
        with a single barren planet, balancing resource production and constructing new buildings to support a growing
        fleet, eventually colonizing further planets in the galaxy to create their own empire. Three main resources must
        be collected to build ships and buildings: Metal, Crystal, and Deuterium. To secure materials, join an alliance
        with other players and raid enemies for resources or promote free trade amongst members.
      </Text>
